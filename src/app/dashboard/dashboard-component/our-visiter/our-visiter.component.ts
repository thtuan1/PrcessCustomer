...
import { ApexChart, ApexDataLabels, ApexLegend, ApexNonAxisChartSeries, ApexPlotOptions, ApexResponsive, ApexTooltip, ChartComponent } from 'ng-apexcharts';
...
export class OurVisiterComponent {
  ...
  public VisitorChartOptions: Partial<VisitorChartOptions> |any;
